...
#include "modelTests/TestModel.hpp"
#include <string>
...
void
TestModel::schedulerSetupTests(void)
{
...
void
TestModel::generatorSetupTests(void)
{
	scheduler->setupModels();
...
void
TestModel::zoneSetupTests(void)
{
//	CPPUNIT_ASSERT (scheduler != NULL);
}

void
TestModel::baSetupTests(void)
{
//	CPPUNIT_ASSERT (scheduler != NULL);
}
